...
Системы контроля версий, или VCS (version control systems) придумали, чтобы контролировать изменения исходного кода и комфортно работать над ним большой командой.
